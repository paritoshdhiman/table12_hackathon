"""AgentCore Runtime entrypoint for the Market Analyst Agent.

Wraps the Anthropic Bedrock SDK agent with BedrockAgentCoreApp so it can be
deployed to Amazon Bedrock AgentCore as a serverless microVM.
"""
...
def invoke(payload, context):
    log.info("MarketAnalystAgent invocation received")
